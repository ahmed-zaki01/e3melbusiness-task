...
<div class="card card-primary mt-5">
    ...
    <div class="card-header">
        <div class="d-flex justify-content-between">
            <h3 class="card-title mt-2"><i class="fa fa-map-marker mr-1"></i> Edit Category | {{ $category->name }}</h3>
                ...
                <div class="col-sm-6">
                    <div class="form-group clearfix">
                        ...
                        <div class="icheck-primary d-inline">
                            <input type="radio" id="enabled" name="active" value="1" {{$category->active == '1' ? 'checked':''}}>
                            <label for="enabled">Yes</label>
                        </div>
                        <div class="icheck-danger ml-2 d-inline">
                            <input type="radio" id="disabled" name="active" value="0" {{$category->active == '0' ? 'checked':''}}>
